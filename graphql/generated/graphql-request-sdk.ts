...
export type TopicEntryFragment = { __typename?: 'Topic', title: string, content: string, subtopics?: { __typename?: 'SubtopicRelationResponseCollection', data: Array<{ __typename?: 'SubtopicEntity', id?: string | null, attributes?: { __typename?: 'Subtopic', title: string, content: string } | null }> } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getTutorialIndexes(variables?: GetTutorialIndexesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetTutorialIndexesQuery> {
    ...
    getChapterById(variables: GetChapterByIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetChapterByIdQuery> {
