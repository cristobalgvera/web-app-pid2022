...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getSubtopicById(variables: GetSubtopicByIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetSubtopicByIdQuery> {
    ...
    getTopicById(variables: GetTopicByIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetTopicByIdQuery> {
